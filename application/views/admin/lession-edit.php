                ...
                foreach($lessiondetails as $lession){

                    ?>
            

                 <form action="<?php echo base_url("admin/lessionupdate-confirm/{$lession->id}") ;?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="title" type="text"  name="title"class="form-control" value="<?php echo $lession->title ;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="title" class="col-md-3 col-form-label form-label">Video Duration</label>
                                        <div class="col-md-6">
                                            <input id="title" type="text"  name="duration" class="form-control" value="<?php echo $lession->duration ;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
