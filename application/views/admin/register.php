...
<head>
    ...
    <!--favicon-->
    <link href="<?php echo base_url();?>oassets/images/favicon.ico" rel="shortcut icon">

    <!--Preloader-CSS-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/plugins/preloader/preloader.css">

    <!--bootstrap-4-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/css/bootstrap.min.css">

    <!--Custom Scroll-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/plugins/customScroll/jquery.mCustomScrollbar.min.css">
    <!--Font Icons-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/simple-line/css/simple-line-icons.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/dripicons/dripicons.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/ionicons/css/ionicons.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/eightyshades/eightyshades.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/foundation/foundation-icons.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/metrize/metrize.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/typicons/typicons.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/icons/weathericons/css/weather-icons.min.css">

    <!--Date-range-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/plugins/date-range/daterangepicker.css">
    <!--Drop-Zone-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/plugins/dropzone/dropzone.css">
    <!--Full Calendar-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/plugins/full-calendar/fullcalendar.min.css">
    <!--Normalize Css-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/css/normalize.css">
    <!--Main Css-->
    <link rel="stylesheet" href="<?php echo base_url();?>oassets/css/main.css">
</head>
<body>
...
<div id="ip-container" class="ip-container">
    <header class="ip-header">
        <h1 class="ip-logo text-center"><img class="img-fluid" src="oassets/images/logo-c.png" alt="" class="ip-logo text-center"/></h1>
        <div class="ip-loader">
...
<!--Jquery-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/js/jquery-3.2.1.min.js"></script>
<!--Bootstrap Js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/js/popper.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>oassets/js/bootstrap.min.js"></script>
<!--Modernizr Js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/js/modernizr.custom.js"></script>

<!--Morphin Search JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/morphin-search/classie.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/morphin-search/morphin-search.js"></script>
<!--Morphin Search JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/preloader/pathLoader.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/preloader/preloader-main.js"></script>

<!--Chart js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/charts/Chart.min.js"></script>

<!--Sparkline Chart Js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/sparkline/jquery.charts-sparkline.js"></script>

<!--Custom Scroll-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/customScroll/jquery.mCustomScrollbar.min.js"></script>
<!--Sortable Js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/sortable2/sortable.min.js"></script>
<!--DropZone Js-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/dropzone/dropzone.js"></script>
<!--Date Range JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/date-range/moment.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/date-range/daterangepicker.js"></script>
<!--CK Editor JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/ckEditor/ckeditor.js"></script>
<!--Data-Table JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/data-tables/datatables.min.js"></script>
<!--Editable JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/editable/editable.js"></script>
<!--Full Calendar JS-->
<script type="text/javascript" src="<?php echo base_url();?>oassets/plugins/full-calendar/fullcalendar.min.js"></script>

<!--- Main JS -->
<script src="<?php echo base_url();?>oassets/js/main.js"></script>
