                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item dropdown ml-1 ml-md-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url('admin/account-edit/').$this->session->userdata("id");?>">
                                        <i class="material-icons">edit</i> Edit Account
                                    </a>
                                    <a class="dropdown-item" href="<?php echo base_url('admin/profile-view/').$this->session->userdata("id");?>">
                        ...
                        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                            <div class="sidebar-p-y">
                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="account_menu">
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/question-post');?>">
                                                    <span class="sidebar-menu-text">Post Question</span>
                                                </a>
                                            </li>
                                            <!-- <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/signup_view');?>">
                                                    <span class="sidebar-menu-text">Signup view</span>
                                                </a>
                                            </li> -->
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/register');?>">
                                                    <span class="sidebar-menu-text">add member</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/course-post');?>">
                                                    <span class="sidebar-menu-text">Course Post</span>
                                                </a>
                                            </li>
                                            
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/course-view');?>">
                                                    <span class="sidebar-menu-text">Course view</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/question-view');?>">
                                                    <span class="sidebar-menu-text">question view</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/lession-view');?>">
                                                    <span class="sidebar-menu-text">lession view</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/section-post');?>">
                                                    <span class="sidebar-menu-text">Add Section</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/lession-post');?>">
                                                    <span class="sidebar-menu-text">Lession Post</span>
                                                </a>
                                            </li>                                                                                
									...
									<li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button sidebar-js-collapse" data-toggle="collapse" href="#students_menu">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">person_outline</i>
                                            all students 
                                            <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                        </a>
                                        <ul class="sidebar-submenu sm-indent collapse" id="students_menu">
                                           
                                           
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/students-views');?>">
                                                    <span class="sidebar-menu-text">students-views</span>
                                                </a>
                                            </li>
									...
									<li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button sidebar-js-collapse" data-toggle="collapse" href="#instructor_menu">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">person_outline</i>
                                            all instructor 
                                            <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                        </a>
                                        <ul class="sidebar-submenu sm-indent collapse" id="instructor_menu">
                                           
                                           
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/instructor-views');?>">
                                                    <span class="sidebar-menu-text">instructor-views</span>
                                                </a>
                                            </li>
                                ...
                                <ul class="sidebar-menu sm-active-button-bg">
									...
									<li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button sidebar-js-collapse" data-toggle="collapse" href="#question_menu">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="question_menu">
											...
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/question_bank-post');?>">
                                                    <span class="sidebar-menu-text">quesion bank Post</span>
                                                </a>
                                            </li>      
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/question_bank-views');?>">
                                                    <span class="sidebar-menu-text">quesion bank views</span>
                                                </a>
											</li>     
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/quiz_master-post');?>">
                                                    <span class="sidebar-menu-text">quiz_master Post</span>
                                                </a>
                                            </li>      
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/quiz_master-views');?>">
                                                    <span class="sidebar-menu-text">quiz_master views</span>
                                                </a>
                                            </li>                 
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/questions_bank_details-post');?>">
                                                    <span class="sidebar-menu-text">questions_bank_details Post</span>
                                                </a>
                                            </li>      
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/questions_bank_details-views');?>">
                                                    <span class="sidebar-menu-text">questions_bank_details views</span>
                                                </a>
                                            </li>    
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/quiz_questions-post');?>">
                                                    <span class="sidebar-menu-text">quiz_questions Post</span>
                                                </a>
                                            </li>      
											<li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/quiz_questions-views');?>">
                                                    <span class="sidebar-menu-text">quiz_questions views</span>
                                                </a>
                                            </li>                                                          
                                    ...
                                    <li class="sidebar-menu-item">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="forum_menu">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/categories-post');?>">
                                                    <span class="sidebar-menu-text">Categories Post</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/categories-view');?>">
                                                    <span class="sidebar-menu-text">Categories View</span>
                                                </a>
                                            </li>                                          
                                        </ul>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" data-toggle="collapse" href="#tags">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">chat_bubble_outline</i>
                                           tags 
                                            <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                        </a>
                                        <ul class="sidebar-submenu sm-indent collapse" id="tags">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/tags');?>">
                                                    <span class="sidebar-menu-text">tags </span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="<?php echo base_url('admin/tags-view');?>">
                                                    <span class="sidebar-menu-text">tags all View</span>
                                                </a>
                                            </li>                                          
                                        </ul>
                                    </li>
