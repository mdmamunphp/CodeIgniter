                        ...
                        <div class="card">
                            ...
                            <div class="tab-content card-body">
                                <div class="tab-pane active" id="first">
                                    <form action="<?php echo base_url("admin/students-update/{$students['id']}") ;?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input id="name" type="text" class="form-control" placeholder="Name" name="name" value="<?php echo $students['name'];?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" placeholder="Last Name"name="last_name" value="<?php echo $students['last_name'];?>" >
													</div>												
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="email" class="form-control" placeholder="Email Address" name="email" value="<?php echo $students['email'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="website" class="form-control" placeholder="www." name="contact"value="<?php echo $students['contact'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="password"value="<?php echo $students['password'];?>"name="password" class="form-control" placeholder="Enter new password">
                                                </div>
                                            </div>
										</div>
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="input-group">
													...
													<input type="text" id="password"  name="type" value="<?php echo $students['type'];?>" class="form-control" >
													<input type="hidden" name="id" value="<?php echo $students['id'];?>" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
