									...
									<div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
										...
										<table class="table mb-0">
											...
											<tbody class="list" id="staff">
												<?php
                                                foreach ($students_views as $students) {
                                                    ?>
												...
												<td>
													...
													<td>
														...
														<div class="media align-items-center">
															...
															<div class="media-body">
																...
																<span class="js-lists-values-employee-name"><?php echo $students['name'];?></span>
													...
													<td>
														<div class="btn-group">
															<a href="<?php echo base_url('admin/students-edit/').$students['id'];?>" class="text-muted"><button type="button" class="btn btn-sm btn-info">edit</button></a>
															<a href="<?php echo base_url('admin/students-singleviews/').$students['id'];?>" class="text-muted"><button type="button" class="btn btn-sm btn-success">view</button></a>
															<a href="<?php echo base_url('admin/students-delete/').$students['id'];?>" class="text-muted"><button type="button" class="btn btn-danger btn-sm">delete</button></a>
														</div>
												   </td>
