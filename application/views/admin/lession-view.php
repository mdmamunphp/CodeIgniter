                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <a href="instructor-course-edit.html" class="avatar avatar-lg avatar-4by3 mb-3 w-xs-plus-down-100 mr-sm-3">
                                                <img src="<?php echo base_url();?>dassets/images/vuejs.png" alt="Card image cap" class="avatar-img rounded">
                                            </a>
                                            <div class="flex" style="min-width: 200px;">
                                                <!-- <h5 class="card-title text-base m-0"><a href="instructor-course-edit.html"><strong>Learn Vue.js</strong></a></h5> -->
                                                <h4 class="card-title mb-1"><a href="instructor-course-edit.html"><?php echo $result->title ;?> Learn Vue.js</a></h4>
                                                <!-- <p class="text-black-70"><?php echo $result->description ;?></p> -->
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-1 border-bottom">
                                                            <small class="text-black-70 mr-2">price:</small>
                                                            <small class="text-black-50">Discount: </small>
                                                        </div>
                                                        <div class="d-flex align-items-center py-1">
                                                            <small class="text-muted mr-2">price:</small>
                                                            <small class="text-muted">Discount: </small>
                                                        </div>
                                                    </div>
                                                    <div class="text-center">
                                                        <a href="<?php echo base_url('admin/lession-edit/').$result->id;?>" class="btn btn-sm btn-primary">Edit</a>
                                                        <a href="<?php echo base_url('admin/lessionsingle-view/').$result->id;?>" class="btn btn-sm btn-success">View</a>
                                                        <a href="<?php echo base_url('admin/lession-delete/').$result->id;?>"  class="btn btn-sm btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <a href="instructor-course-edit.html" class="avatar avatar-lg avatar-4by3 mb-3 w-xs-plus-down-100 mr-sm-3">
                                                <img src="<?php echo base_url();?>dassets/images/nodejs.png" alt="Card image cap" class="avatar-img rounded">
                                            </a>
                                            <div class="flex" style="min-width: 200px;">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <a href="instructor-course-edit.html" class="avatar avatar-lg avatar-4by3 mb-3 w-xs-plus-down-100 mr-sm-3">
                                                <img src="<?php echo base_url();?>dassets/images/github.png" alt="Card image cap" class="avatar-img rounded">
                                            </a>
                                            <div class="flex" style="min-width: 200px;">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <a href="instructor-course-edit.html" class="avatar avatar-lg avatar-4by3 mb-3 w-xs-plus-down-100 mr-sm-3">
                                                <img src="<?php echo base_url();?>dassets/images/gulp.png" alt="Card image cap" class="avatar-img rounded">
                                            </a>
                                            <div class="flex" style="min-width: 200px;">
