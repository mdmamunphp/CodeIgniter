                                        ...
                                        <table class="table mb-0">
											...
											<?php
												...
												<td>
                                                    ...
                                                    <td>
														<a href="<?php echo base_url('admin/categories-edit/').$result->id;?>" class="btn btn-sm btn-primary">Edit</a>
														<a href="<?php echo base_url('admin/categoriessingle-view/').$result->id;?>" class="btn btn-sm btn-success">View</a>
														<a href="<?php echo base_url('admin/categories-delete/').$result->id;?>"  class="btn btn-sm btn-danger">Delete</a>
													</td>
												</tr>
												<?php
													}
