...
<div class="container-fluid page__container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form id="upform" action="<?php echo base_url("admin/tags-confirm") ;?>" enctype="multipart/form-data" method="post">
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">tags Name:</label>
                                        <div class="col-sm-9">
                                            <input id="quiz_title" type="text" name="name" class="form-control" placeholder="category name" >
                                        </div>
                                    </div>                                 
