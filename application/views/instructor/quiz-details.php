<div class="container-fluid page__container">
                        ...
                        <div class="card">
                            <ul class="nav nav-tabs nav-tabs-card">
								...
								<li class="nav-item">
                                    <a class="nav-link active" href="#first" data-toggle="tab">All Questions</a>
								</li>
								<?php
                                }else{
                                    ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#second"  data-toggle="tab">Review</a>
								</li>
								<?php
								}
								?>
                                ...
                                <div class="tab-pane active" id="first">
                                    <ul class="list-group mb-0 list-group-fit">
										<?php
                                            ...
                                            foreach ($question_all as $lession) {
                                                ?>
										
                                        <li class="list-group-item">
											<a href="<?php echo base_url('instructor/quiz-singleviews/').$lession['id']; ?>">
												<div class="media">
													<div class="media-left">
														<div class="text-muted-light">1.</div>
													</div>
													<div class="media-body"><?php echo $lession['title']; ?></div>
													<div class="media-right"><strong class="text-primary"></strong></div>
												</div>
											</a>
										</li>
										<?php
