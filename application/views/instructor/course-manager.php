                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                ...
                                                <h4 class="card-title mb-1"><a href="instructor-course-edit.html"><?php echo $course['title'];?></a></h4>
                                                <p class="text-black-70"><?php echo $course['description'];?></p>
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-1 border-bottom">
                                                            <small class="text-black-70 mr-2">Price: &dollar;<?php echo $course['price'];?></small>
                                                    ...
                                                    <div class="text-center">
                                                        <a href="<?php echo base_url('admin/course-edit/').$course['id'];?>" class="btn btn-sm btn-white">Edit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card__options dropdown right-0 pr-2">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
											...
											<a class="dropdown-item" href="<?php echo base_url('admin/coursesingle-view/').$course['id'];?>">Views </a>
											<!-- <a class="dropdown-item" href="#">Course Insights</a> -->
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item text-danger" href="<?php echo base_url('admin/course-delete/').$course['id'];?>">Delete course</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
