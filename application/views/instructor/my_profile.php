<div class="bg-primary mdk-box js-mdk-box mb-0" style="height: 192px;" data-effects="parallax-background blend-background">
			<div class="mdk-box__bg">
				<div class="mdk-box__bg-front" style="background-image: url(<?php echo base_url();?>dassets/images/1280_rsz_aman-dhakal-205796-unsplash.jpg); background-position: center;"></div>
			</div>
		</div>
		...
		<div class="avatar avatar-xxl position-absolute bottom-0 left-0 right-0">
			<img src="<?php echo base_url();?>dassets/images/256_rsz_clem-onojeghuo-150467-unsplash.jpg" alt="avatar" class="avatar-img rounded-circle border-3">
		</div>
		<ul class="nav nav-tabs-links flex" style="margin-left: 265px;">
			<li class="nav-item">
				<a href="student-profile.html" class="nav-link active">Courses</a>
			</li>
			<li class="nav-item">
				<a href="student-profile-posts.html" class="nav-link">Posts</a>
			</li>
		</ul>
		</div>
		...
		<div class="row flex-sm-nowrap">
			<div class="col-sm-auto mb-3 mb-sm-0" style="width: 265px;">
				<h1 class="h2 mb-1"><?php echo $my_info['name'];?></h1>
				...
				<h4>Connect</h4>
				<p class="text-black-70 measure-paragraph">	<?php echo $my_info['contact'];?></p>
				<p class="text-black-70 measure-paragraph">
					I’m currently working as a freelance marketing director and always interested in a challenge. Here’s how to reach out and connect.</p>
			</div>
			<div class="col-sm">
		...
		<input type="text" class="form-control" placeholder="Search" id="searchSample02">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<a href="student-take-course.html" class="mr-3">
								<img src="<?php echo base_url();?>dassets/images/vuejs.png" width="100" alt="" class="rounded">
							</a>
							<div class="flex">
					...
					<ul class="list-group list-group-fit">
						<li class="list-group-item">
							<a href="student-view-course.html" class="text-body text-decoration-0 d-flex align-items-center">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<a href="student-take-course.html" class="mr-3">
								<img src="<?php echo base_url();?>dassets/images/nodejs.png" alt="" class="rounded" width="100">
							</a>
							<div class="flex">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<a href="student-take-course.html" class="mr-3">
								<img src="<?php echo base_url();?>dassets/images/github.png" alt="" class="rounded" width="100">
							</a>
