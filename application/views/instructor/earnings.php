                                    ...
                                    foreach($mycourse as $course){
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong><?php echo $course['title'];?></strong></a>
                                            ...
                                            <td class="text-center text-black-70">
                                                ...
                                                &dollar;<span class="js-lists-values-fees"> <?php echo $course['amount'];?></span> USD

                                            </td>
                                            <td class="text-center text-black-70">
                                                &dollar;<span class="js-lists-values-revenue"> <?php echo $course['amount'];?></span> USD
                                            </td>
                                        </tr>
                                        <?php
                                        }
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>Angular Unit Testing</strong></a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>Introduction to TypeScript</strong></a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <a class="text-body js-lists-values-course" href="instructor-course-edit.html"><strong>Learn Angular Fundamentals</strong></a>
