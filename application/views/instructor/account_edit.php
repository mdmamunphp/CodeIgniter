                        ...
                        <div class="card">
                            ...
                            <div class="tab-content card-body">
                                <div class="tab-pane active" id="first">
                                    <form  action="<?php echo base_url("instructor/account-update/". $my_info['id']) ;?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                                ...
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="custom-file" style="width: auto;">
                                                            <input type="file" id="avatar" name="images" value="<?php echo $my_info['images'];?>" class="custom-file-input">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input id="name" type="text" class="form-control" placeholder="First Name"name="name" value="<?php echo $my_info['name'];?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" placeholder="Last Name"name="last_name" value="<?php echo $my_info['last_name'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="email" class="form-control"name="email" placeholder="Email Address" value="<?php echo $my_info['email'];?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"  class="form-control" value="<?php echo $my_info['contact'];?>" name="contact">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="password" class="form-control" name="password"value="<?php echo $my_info['password'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
