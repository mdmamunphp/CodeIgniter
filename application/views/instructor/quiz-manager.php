<div class="container-fluid page__container">
                        ...
                        <div class="media align-items-center mb-headings">
                            ...
                            <div class="media-right d-flex align-items-center">
                                <a href="instructor-quiz-edit.html" class="btn btn-success mr-2">Add quiz</a>
                                <div class="dropdown">
                        ...
                        foreach ($post_course as $course) {
                            ...
                            <div class="card card-sm">
                                <div class="card-body media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="card-title mb-0"><a href="instructor-review-quiz.html"><?php echo $course['title'];?></a></h4>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="<?php echo base_url('instructor/quiz-details/').$course['id'];?>" class="btn btn-default btn-sm float-right"><i class="material-icons btn__icon--left">edit</i> quiz details </a>
