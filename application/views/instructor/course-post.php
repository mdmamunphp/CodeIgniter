<div class="container-fluid page__container">
                        ...
                        ?>
                        <form action="<?php echo base_url("instructor/post-confirm") ;?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div style="height: 150px;" data-toggle="quill" >
                                                <textarea type="text" name="description" placeholder="Write a Description" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="Price">Price</label>
                                            <input type="text" name="price" id="Price" class="form-control" placeholder="Write a Price" >
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="Discount">Discount</label>
                                            <input type="text" name="discount" id="Discount" class="form-control" placeholder="Write a Discount" >
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="requirement">Requirement </label>
                                            <input type="text" name="requirement" id="requirement " class="form-control" placeholder="Write a requirement " >
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
