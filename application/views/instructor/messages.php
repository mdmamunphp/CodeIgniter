                                ...
                                <div class="flex pt-4" style="position: relative;" data-perfect-scrollbar>
                                    <div class="container-fluid page__container">
                                        ...
                                        <ul class="d-flex flex-column list-unstyled" id="messages">
                                            ...
                                            <li class="message d-inline-flex">
                                                <div class="message__aside">
                                                    <a href="instructor-profile.html" class="avatar">
                                                        <img src="<?php echo base_url();?>dassets/images/people/110/guy-6.jpg" alt="people" class="avatar-img rounded-circle">
                                                    </a>
                                                </div>
                                            ...
                                            <li class="message d-inline-flex">
                                                ...
                                                <div class="message__body card">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex mr-3">
                                                                <a href="instructor-profile.html" class="text-body"><strong><?php echo $send['sname'];?></strong></a>
                                                            </div>
                                                            <div>
                                                                <small class="text-muted">5 minutes ago</small>
                                                            </div>
                                                        </div>
                                                        <span class="text-black-70"><?php echo $send['description'];?></span>
											...
											?>
											<?php
                                            if (isset($messages_all)) {
                                                foreach ($messages_all as $messages) {
													echo $send['uname'];
                                                    ?>
                                            ...
                                            <li class="message d-inline-flex">
                                                ...
                                                <div class="message__body card">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex mr-3">
                                                                <a href="instructor-profile.html" class="text-body"><strong><?php echo $send['uname'];?></strong></a>
                                                            </div>
                                                            <div>
                                                                <small class="text-muted">5 minutes ago</small>
                                                            </div>
                                                        </div>
                                                        <span class="text-black-70">🔥 <?php echo $messages['description'];?></span>
...
<!-- 									
									<form action="<?php echo base_url("instructor/messages-confirm"); ?>"id="message-reply" enctype="multipart/form-data" method="post">
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control form-control-appended" name="description" autofocus="" required="" placeholder="Type message">
									...
									<form action="<?php echo base_url("instructor/messages-confirm"); ?>" enctype="multipart/form-data" method="post">
												<div class="input-group">
													<input type="text" class="form-control" name="description" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2">
													<div class="input-group-append">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="flex" data-perfect-scrollbar>
                                                ...
                                                <li class="list-group-item px-4 py-3 bg-light">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/woman-5.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                            ...
                                            if (isset($users_all)) {
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="<?php echo base_url('instructor/messages-chat/').$users['id'];?>" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">

                                                            <img src="<?php echo base_url();?>dassets/images/people/50/guy-2.jpg" alt="Avatar" class="avatar-img rounded-circle">

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body"><?php echo $users['name'];?></strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/woman-2.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/woman-1.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/woman-3.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                ...
                                                <li class="list-group-item px-4 py-3 bg-light">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/guy-1.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                            ...
                                                            <img src="<?php echo base_url();?>dassets/images/people/50/guy-3.jpg" alt="Avatar" class="avatar-img rounded-circle">
    ...
    <!-- Messages App -->
    <script src="<?php echo base_url();?>dassets/js/messages.js"></script>
