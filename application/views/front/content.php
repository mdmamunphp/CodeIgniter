                ...
                <div class="section section-padding choose-course">
                    <div class="container">
                        ...
                        <div class="choose-course-wrapper row">
							<?php foreach($category->result_array() as $cate){
								?>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-1">
                                    ...
                                    <div class="name-course"><a href="courses.html"><?php echo $cate['name'];?></a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
							</div>
							<?php } 
							?>
                                ...
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            <div class="edugate-content"><a href="courses-detail.html" class="title"><?php echo $result->title ;?> </a>
                                                ...
                                                <button onclick="window.location.href='courses-detail.html'" class="btn btn-green"><span><a href="<?php echo base_url('front/coursedetails/').$result->id;?>" style="color:white;">learn now</a></span></button>
                                            </div>
                                            <div class="edugate-image"><img src="<?php echo base_url();?>assets/images/courses/courses-1.jpg" alt="" class="img-responsive"/></div>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            ...
                                            <div class="edugate-image"><img src="<?php echo base_url();?>assets/images/courses/courses-2.jpg" alt="" class="img-responsive"/></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            ...
                                            <div class="edugate-image"><img src="<?php echo base_url();?>assets/images/courses/courses-3.jpg" alt="" class="img-responsive"/></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            ...
                                            <div class="edugate-image"><img src="<?php echo base_url();?>assets/images/courses/courses-4.jpg" alt="" class="img-responsive"/></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
