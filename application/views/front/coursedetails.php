...
<!-- Mirrored from swlabs.co/edugate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Mar 2020 14:08:14 GMT -->
        ...
        <div class="container">
            ...
            <div class="topbar-right pull-right">
                ...
                <div class="group-sign-in">
                   ...
                   <?php if(isset($id)){
                       ?>
                         <a href="<?php echo base_url('admin/dashboard');?>"  class="login">Dashboard</a>
                         <a href="<?php echo base_url('admin/logout');?>" class="register">Logout</a>
                         <?php

                    }else{
                        ?>
                         <a href="<?php echo base_url('front/login');?>" class="login">login</a>
                    <a href="<?php echo base_url('front/reg');?>" class="register">register</a>
                    <?php
            ...
            <div class="header-main-wrapper">
                ...
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                        <li class="dropdown active"><a href="<?php echo base_url('index'); ?>" class="main-menu">Home<span class="fa fa-angle-down icons-dropdown"></span></a>
                            ...
                            <div class="row">
                                <div class="col-md-9 layout-left"><h1 class="course-title">GETTING STARTED WITH DJANGO</h1>
                                    ...
                                    <div class="course-des">
                                        ...
                                        <div class="course-des-content"><p>
                                        <?php 
                                ...
                                <div class="col-md-3 sidebar layout-right">
                                    <div class="row">
                                        <div class="course-price-widget widget col-sm-6 col-md-12 col-xs-6 sd380">
                                            ...
                                            <div class="content-widget">
                                                <div class="course-price-widget-wrapper">
                                                    ...
                                                    <button class="btn btn-green" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"><span>join now</span></button>
                                                    <!---modal for join now ---->                                                   
                                                    ...
                                                    <form action="<?php echo base_url('front/application-confirm') ;?>" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inlineFormCustomSelect" class="col-sm-2 col-form-label col-form-label-sm">Payment Method</label>
                                                                    <div class="col-sm-10">
                                                                        <select class="form-control" name="payment_method" id="inlineFormCustomSelect">
                                                                               
                                                                                <option selected>Choose...</option>
                                                                                <?php 
                                                                                $res = $this->om->view("*", "payment_method");
                                                                                foreach($res as $p){
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="colFormLabel" class="col-sm-2 col-form-label">Transaction id</label>
                                                                    <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="transaction_id" id="colFormLabel" placeholder="Transaction Id">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input type="submit" class="btn btn-green" style="color:white;" value="Send message">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="author-widget widget col-sm-6 col-md-12 col-xs-6 sd380">
                                            <?php
                                            $ins=$this->om->view("*", "instructor", ['id' =>$result->instructor_id]);

                                           // print_r($ins);
                                                foreach($ins as $instructor){
                                            ?>
                                            <div class="title-widget">about <?php echo $instructor->name;?></div>
                                            <div class="content-widget">
                                                <div class="staff-item author-widget-wrapper customize">
                                                    <div class="staff-item-wrapper">
                                                        <div class="staff-info"><a href="#" class="staff-avatar"><img src="<?php echo base_url();?>assets/images/people-avatar-3.jpg" alt="" class="img-responsive"/></a><a href="#" class="staff-name"><?php echo $instructor->name;?></a>

                                                            <div class="staff-job"><?php echo $instructor->designation;?></div>
                                                            <div class="staff-desctiption"><?php echo $instructor->short_desc;?></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="popular-course-widget widget col-sm-6 col-md-12 col-xs-6 sd380">
                                            ...
                                            <div class="content-widget">
                                                <div class="media">
                                                    <div class="media-left"><a href="courses-detail.html" class="link"><img src="<?php echo base_url();?>assets/images/popular/popular-1.jpg" alt="" class="media-image"/></a></div>
                                                ...
                                                <div class="media">
                                                    <div class="media-left"><a href="courses-detail.html" class="link"><img src="<?php echo base_url();?>assets/images/popular/popular-2.jpg" alt="" class="media-image"/></a></div>
                                                    <div class="media-right">
                                                ...
                                                <div class="media">
                                                    <div class="media-left"><a href="courses-detail.html" class="link"><img src="<?php echo base_url();?>assets/images/popular/popular-3.jpg" alt="" class="media-image"/></a></div>
                                                    <div class="media-right">
                                                ...
                                                <div class="media">
                                                    <div class="media-left"><a href="courses-detail.html" class="link"><img src="<?php echo base_url();?>assets/images/popular/popular-4.jpg" alt="" class="media-image"/></a></div>
                                                    <div class="media-right">
                    ...
                    <div class="col-2">
                        <div class="col-md-3 col-sm-6 col-xs-6 sd380">
                            <div class="gallery-widget widget">
                                ...
                                <div class="content-widget">
                                    <div class="gallery-list"><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-01.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-02.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-03.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-04.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-05.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-06.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-07.jpg" alt="" class="img-responsive"/></a><a href="#" class="thumb"><img src="<?php echo base_url();?>assets/images/gallery/gallery-08.jpg"
...
<script src="<?php echo base_url();?>assets/libs/isotope/fit-columns.js"></script>
<script src="<?php echo base_url();?>assets/js/pages/homepage.js"></script>
</body>

<!-- Mirrored from swlabs.co/edugate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Mar 2020 14:09:31 GMT -->
</html>