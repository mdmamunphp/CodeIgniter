                    ...
                    <div class="container">
                        ...
                        <div class="register-wrapper rlp-wrapper">
                            ...
                            <div class="register-table rlp-table"><a href="index.html"><img src="<?php echo base_url();?>assets/images/logo-color-1.png" alt="" class="login"/></a>
                                ...
                                <form action="<?php echo base_url("students/register-confirm") ;?>" enctype="multipart/form-data" method="post">
                                <div class="register-form bg-w-form rlp-form">
                                    <div class="row">
                                         <div class="col-md-6"><label for="regname" class="control-label form-label">NAME <span class="highlight">*</span></label><input id="regname" name="fullname"type="text" placeholder="" class="form-control form-input"/><!--p.help-block Warning !--></div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-7 col-lg-5">
                    <div class="register-div">
                        ...
                        ?>
                        <form id="needs-validation" action="<?php echo base_url("students/register-confirm") ;?>" enctype="multipart/form-data" method="post">
