                                            ...
                                            <li class="message d-inline-flex">
                                                ...
                                                <div class="message__body card">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex mr-3">
                                                                <a href="instructor-profile.html" class="text-body"><strong>receive</strong></a>
                                                            </div>
                                                            <div>
                                                                <small class="text-muted">5 minutes ago</small>
                                                            </div>
                                                        </div>
                                                        <span class="text-black-70">🔥 <?php echo $messages['mdes'];?></span>
...
<!-- 									
									<form action="<?php echo base_url("students/messages-confirm"); ?>"id="message-reply" enctype="multipart/form-data" method="post">
									...
									<form action="<?php echo base_url("students/messages-confirm"); ?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="flex" data-perfect-scrollbar>
                                            ...
                                            if (isset($users_all)) {
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="<?php echo base_url('students/messages-chat/').$users['id'];?>" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">
