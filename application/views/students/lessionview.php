...
<div class="container-fluid page__container">
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <!-- <iframe class="embed-responsive-item" src="https://player.vimeo.com/video/97243285?title=0&amp;byline=0&amp;portrait=0" allowfullscreen=""></iframe> -->
                                            <iframe id="w3s"src="https://www.youtube.com/embed/IIioz33Ojtc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <div class="card-body">
                           ...
                           foreach($mycourse->result_array() as $course){
                               $id=$course['id'];
   
                               ?>
                                    <li id="m<?php echo $course['id'] ;?>" class="list-group-item">
                                        <div class="media">
                                            <div class="media-left">
                                                <div class="text-muted"><?php echo $course['id'] ;?></div>
                                            </div>
                                            <div class="media-body">                                                
                                                <a class="m<?php echo $course['id'] ;?>" href="#"class="text-white"><?php echo $course['title'] ;?></a>
                                            </div>
                                            <div class="media-right">
                                                <small class="text-muted-light">2:03</small>
                                            </div>
