...
class Custom_model extends CI_Model {
    ...
    public function UploadImg($dest, $name, $field, $max_size = 10000, $max_width = 6000, $max_height = 6000, $allowed_types = 'gif|jpg|png|mp4'){
	...
	// public function UploadVideo($dest, $name, $field,  $allowed_types = 'gif|jpg|png|mp4|pdf|txt'){

    //     $this->load->library('upload');
    //     $config['upload_path'] = "./{$dest}";
    //     $config['allowed_type'] = $allowed_types;
    //     $config['max_size']     = 0;
